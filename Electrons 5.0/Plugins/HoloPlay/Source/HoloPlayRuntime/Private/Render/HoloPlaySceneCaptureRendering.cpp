...
static void CreateSceneRendererForSceneCapture(
	...
	float PostProcessBlendWeight,
	const AActor* ViewActor,
	UHoloPlayRenderingConfig* RenderingConfig
)
{
...
void UHoloPlaySceneCaptureComponent2D::UpdateHoloPlaySceneCaptureContents(USceneCaptureComponent2D* CaptureComponent, UHoloPlayRenderingConfig* RenderingConfig, FSceneInterface* Scene)
{
