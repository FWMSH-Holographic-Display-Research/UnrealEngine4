...
// End Cross Module References
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UHoloPlayLibrary_GetHoloPlaySettings_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HoloPlayLibrary_eventGetHoloPlaySettings_Parms, ReturnValue), Z_Construct_UClass_UHoloPlaySettings_NoRegister, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UHoloPlayLibrary_GetHoloPlaySettings_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UHoloPlayLibrary, nullptr, "GetHoloPlaySettings", nullptr, nullptr, sizeof(Z_Construct_UFunction_UHoloPlayLibrary_GetHoloPlaySettings_Statics::HoloPlayLibrary_eventGetHoloPlaySettings_Parms), Z_Construct_UFunction_UHoloPlayLibrary_GetHoloPlaySettings_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UHoloPlayLibrary_GetHoloPlaySettings_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UHoloPlayLibrary_GetHoloPlaySettings_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UHoloPlayLibrary_GetHoloPlaySettings_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UHoloPlayLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UHoloPlayLibrary_GetHoloPlaySettings, "GetHoloPlaySettings" }, // 3887200826
	};
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_HoloPlay_Source_HoloPlayRuntime_Public_Blueprints_HoloPlayLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UHoloPlayLibrary, UHoloPlayLibrary::StaticClass, TEXT("UHoloPlayLibrary"), &Z_Registration_Info_UClass_UHoloPlayLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoloPlayLibrary), 2792062548U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_HoloPlay_Source_HoloPlayRuntime_Public_Blueprints_HoloPlayLibrary_h_1257237904(TEXT("/Script/HoloPlayRuntime"),
