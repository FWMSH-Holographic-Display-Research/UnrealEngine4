...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UHoloPlayDrawFrustumComponent_Statics::NewProp_FrustumAngle = { "FrustumAngle", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoloPlayDrawFrustumComponent, FrustumAngle), METADATA_PARAMS(Z_Construct_UClass_UHoloPlayDrawFrustumComponent_Statics::NewProp_FrustumAngle_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoloPlayDrawFrustumComponent_Statics::NewProp_FrustumAngle_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UHoloPlayDrawFrustumComponent_Statics::NewProp_FrustumAspectRatio = { "FrustumAspectRatio", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoloPlayDrawFrustumComponent, FrustumAspectRatio), METADATA_PARAMS(Z_Construct_UClass_UHoloPlayDrawFrustumComponent_Statics::NewProp_FrustumAspectRatio_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoloPlayDrawFrustumComponent_Statics::NewProp_FrustumAspectRatio_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UHoloPlayDrawFrustumComponent_Statics::NewProp_FrustumStartDist = { "FrustumStartDist", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoloPlayDrawFrustumComponent, FrustumStartDist), METADATA_PARAMS(Z_Construct_UClass_UHoloPlayDrawFrustumComponent_Statics::NewProp_FrustumStartDist_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoloPlayDrawFrustumComponent_Statics::NewProp_FrustumStartDist_MetaData)) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_HoloPlay_Source_HoloPlayRuntime_Public_Game_HoloPlayDrawFrustumComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UHoloPlayDrawFrustumComponent, UHoloPlayDrawFrustumComponent::StaticClass, TEXT("UHoloPlayDrawFrustumComponent"), &Z_Registration_Info_UClass_UHoloPlayDrawFrustumComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoloPlayDrawFrustumComponent), 3316819664U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_HoloPlay_Source_HoloPlayRuntime_Public_Game_HoloPlayDrawFrustumComponent_h_2155326750(TEXT("/Script/HoloPlayRuntime"),
